<x-cms.layouts.guest title="Register" heading="Create CMS Account">
    <form method="POST" action="{{ route('cms.register.store') }}" class="space-y-4">
        ...
        <label class="block">
            <span class="text-sm font-medium">Email <span class="required-mark">*</span></span>
        ...
        <label class="block">
            <span class="text-sm font-medium">Password <span class="required-mark">*</span></span>
        ...
        <label class="block">
            <span class="text-sm font-medium">Confirm password <span class="required-mark">*</span></span>
